...
// String literal: Any character except quote or backslash OR a backslash followed by any char (this
// allows to escape the quote character) Note: String literals can be multi-line
STRING_LITERAL: '"' ( (~( '"' | '\\') | ('\\' .))*) '"';

// Single quote string literal (un-interpolated)
STRING_LITERAL_SINGLE: '\'' (~( '\''))* '\'';

// 'sys' literal. Everything after a sys statement. Note: It can be multi-line by escaping before
// the end of line
